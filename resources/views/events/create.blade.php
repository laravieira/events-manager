                ...
                <form action="{{ route('events.store') }}"
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2" x-data="{
                        ...
                        <input type="file"
                               ...
                               class="block hidden w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"/>
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <select name="tags[]"
                                id="tags"
                                multiple
                                class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:focus:border-blue-500 focus:border-blue-500 focus:outline-none focus:ring">
                            @foreach($tags as $tag)
