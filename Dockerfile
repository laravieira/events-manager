...
ENV LOG_DEPRECATIONS_CHANNEL $LOG_DEPRECATIONS_CHANNEL:null
...
ENV CACHE_DRIVER $CACHE_DRIVER:r2
ENV FILESYSTEM_DISK $FILESYSTEM_DISK:local
...
ENV VITE_APP_NAME $VITE_APP_NAME:$APP_NAME
ENV VITE_PUSHER_APP_KEY $VITE_PUSHER_APP_KEY:$PUSHER_APP_KEY
ENV VITE_PUSHER_HOST $VITE_PUSHER_HOST:$PUSHER_HOST
ENV VITE_PUSHER_PORT $VITE_PUSHER_PORT:$PUSHER_PORT
ENV VITE_PUSHER_SCHEME $VITE_PUSHER_SCHEME:$PUSHER_SCHEME
ENV VITE_PUSHER_APP_CLUSTER $VITE_PUSHER_APP_CLUSTER:$PUSHER_APP_CLUSTER
